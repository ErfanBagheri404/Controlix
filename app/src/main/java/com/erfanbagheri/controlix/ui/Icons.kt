...
enum class ActionIcon { Power, VolUp, VolDown, ChUp, ChDown, Mute, Up, Down, Left, Right, Ok, Back, Add, Check, Cross, Sweep, CameraTest, Trash, ChevRight, Menu, Macros, QrScan, Star, Share, Edit, Source, Play, Dots, DotsH, Minus, ChevronUp, ChevronDown, ChevronLeft, ChevronRight, Home, Info, Database, Gauge, Waveform }
